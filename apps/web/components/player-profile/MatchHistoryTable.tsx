"use client";
import type { PlayerMatchHistoryDTO } from "@repo/contracts";
...
export const MatchHistoryTable = ({
	...
	return (
		<div className="h-96 rounded-md overflow-y-auto [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-neutral-700 [&::-webkit-scrollbar-thumb]:bg-neutral-500">
			<Table>
				<TableHeader>
					<TableRow>
