            ...
            <TooltipContent className="bg-black border-gray-800">
                <div className="p-3 max-w-md">
                    ...
                    <p className="text-sm text-gray-300 leading-relaxed">
                        O time conseguiu <span className="font-bold text-white">{kills}</span> de{" "}
                        <span className="font-bold text-white">{total}</span> kills possíveis em situações de clutch.
                    </p>
                </div>
            </TooltipContent>
        </Tooltip>
