...
const cardStyle = (result: string) => {
    ...
    else if (result === "Guardou") return "border-yellow-500 bg-yellow-950/40 text-white";
...
export const ClutchCard = ({ clutch }: ClutchCardProps) => {
    ...
    return (
        <div className={`border ${cardStyle(result)} rounded-none aspect-square w-22 pb-0`}>
            <div className="pb-1">
                <div className="flex flex-col gap-0.5 text-center">
                    ...
                    <span className="text-xs">
                        Round {clutch.roundNumber}
                    </span>
                </div>
            </div >
            <div className={`border-t ${resultStyle(result)} pt-0 pb-0 flex justify-center`}>
